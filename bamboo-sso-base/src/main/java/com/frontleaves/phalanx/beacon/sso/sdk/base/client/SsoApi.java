...
public class SsoApi {
    ...
    public SsoAccountApi account() {
        return new SsoAccountApi(properties, grpcAuthClient);
    }
    ...
    public SsoMerchantApi merchant() {
        return new SsoMerchantApi(properties, grpcMerchantClient);
    }
    ...
    public SsoPublicApi pub() {
        return new SsoPublicApi(properties, grpcPublicClient);
    }
    ...
    public SsoUserApi user() {
        return new SsoUserApi(properties, grpcUserClient, httpUserClient);
    }
}
