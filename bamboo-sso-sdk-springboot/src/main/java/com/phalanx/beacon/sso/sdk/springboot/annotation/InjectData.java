package com.phalanx.beacon.sso.sdk.springboot.annotation;
 ...
 * 配合 {@link com.phalanx.beacon.sso.sdk.springboot.aspect.InjectDataAspect} 使用，
 * 可自动将 {@link com.phalanx.beacon.sso.sdk.base.models.OAuthIntrospection} 中的
 * 字段值注入到方法参数中。
 * </p>
 *
 * <pre>{@code
...
public @interface InjectData {
     ...
     * </ul>
     * 若为空字符串，则注入完整的 {@link com.phalanx.beacon.sso.sdk.base.models.OAuthIntrospection} 对象。
     * </p>
     *
     * @return 字段名称，默认为空字符串
     */
